...
AC_CustomControl_PID::AC_CustomControl_PID(AC_CustomControl& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl_Custom*& att_control, AP_MotorsMulticopter*& motors, float dt) : //AKGL
